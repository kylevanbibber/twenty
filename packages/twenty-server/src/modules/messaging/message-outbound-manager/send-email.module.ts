...
import { EmailMessageActionResolver } from 'src/modules/messaging/message-outbound-manager/resolvers/email-message-action.resolver';
...
@Module({
  ...
  providers: [SendEmailResolver, EmailMessageActionResolver],
})
