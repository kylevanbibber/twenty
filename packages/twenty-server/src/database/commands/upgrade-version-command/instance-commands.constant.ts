...
import { AddWorkflowEmailTemplatesWidgetTypeFastInstanceCommand } from './2-15/2-15-instance-command-fast-1782000000000-add-workflow-email-templates-widget-type';
...
export const INSTANCE_COMMANDS = [
  ...
  AddWorkflowEmailTemplatesWidgetTypeFastInstanceCommand,
];
